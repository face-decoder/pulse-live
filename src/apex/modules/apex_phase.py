...
class ApexPhase:
    ...
    def find_phase(self, signal: list, apex_indices: list, cutoff_ratio: float = None, phase_mode: str = "onset_to_apex") -> dict:
        ...
        Args:
            ...
            phase_mode (str): Mode fase yang diminta. Supported:
                - 'onset_to_apex' (default): return onset..apex (end set to apex)
                - 'onset_apex_offset': return onset..offset
                - alias 'full' maps to 'onset_apex_offset'

        Returns:
            dict: Kamus yang berisi informasi fase apex.
        """
        # Normalize and validate phase_mode
        if phase_mode == "full":
        ...
        for idx, apex_index in enumerate(apex_indices):
            ...
            # Adjust according to requested mode
