...
class TSNEPlotter:
    ...
    def show(self, train_feats, train_lbls, val_feats, val_lbls):
        ...
        fig.suptitle(
            "t-SNE Dimensionality Reduction (Feature Distribution)",
            fontsize=16,
            fontweight="bold",
            y=1.02,
        )
        ...
        sns.scatterplot(
            ...
            y="TSNE-2",
            hue="Split",
            palette={"Train": "royalblue", "Validation": "darkorange"},
            alpha=0.7,
            s=60,
            ax=axes[0],
        )
        ...
        sns.scatterplot(
            ...
            style="Class",
            palette={
                self.target_names[0]: "mediumseagreen",
                self.target_names[1]: "crimson",
            },
            alpha=0.8,
            s=70,
            ax=axes[1],
